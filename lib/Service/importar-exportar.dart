...
class ImportarExportar {
  ...
  final InventarioServiceDispositivos _inventarioServiceDispositivos =
  ...
  Future<void> seleccionarArchivoExcel() async {
    ...
    if (result != null) {
      ...
      if (bytes != null) {
        ...
        var sheetDispositivos =
            excel.tables[excel.tables.keys.elementAt(1)]!.rows;
        for (var row in sheetDispositivos.skip(1)) {
          ...
          Dispositivos nuevoDispositivo = Dispositivos(
            ...
            custodio: row[9]?.value.toString() ?? '',
          );
          await _inventarioServiceDispositivos
  ...
  Future<void> exportarDatosExcel() async {
    ...
    List<Dispositivos> dispositivosData =
        await _inventarioServiceDispositivos.obtenerInventario();
    ...
    for (var dispositivo in dispositivosData) {
      sheetDispositivos.appendRow([
        ...
        dispositivo.codigoActFijosDispositivos,
        dispositivo.observaciones,
        dispositivo.custodio,
      ]);
    }
    ...
    if (downloadsDirectory != null) {
      String filePath =
          '${downloadsDirectory.path}/InventarioPCsYDispositivos.xlsx';
